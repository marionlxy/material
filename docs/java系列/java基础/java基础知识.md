...
* [3.关于JVMJDK和JRE最详细通俗的解答](#3关于jvmjdk和jre最详细通俗的解答)
   * [JVM](#jvm)
   * [JDK和JRE](#jdk和jre)
* [4.OracleJDK和OpenJDK的对比](#4oraclejdk和openjdk的对比)
* [5.Java和C  的区别](#5java和c的区别)
...
* [30. 线程有哪些基本状态？这些状态是如何定义的?](#30-线程有哪些基本状态这些状态是如何定义的)
