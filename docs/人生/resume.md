...
### 项目描述
该项目是一个大数据物联网联项目、主要监控、车辆、人员、设施设备的日常运行。前后端分离主要使用了springmvc，jsp传统技术，高德GIS分析技术
...
2. 学习了解地图相关知识理论，地图坐标系分层，地图覆盖等技术
3. 协助成员怎么进行地图应用调试开发，比如处理分析地图轨迹渲染，轨迹描边，纠偏，重合率等计算问题
